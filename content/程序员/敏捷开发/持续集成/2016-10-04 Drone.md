...
## 命令使用
drone repo add thinkphp5/jinbaiwei                 #
drone repo update --trusted thinkphp5/jinbaiwei    # privileged
drone repo repair thinkphp5/jinbaiwei              # repair repository webhooks
